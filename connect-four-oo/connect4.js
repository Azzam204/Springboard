...
class Game {
  ...
  placeInTable(y, x) {
    ...
    this.currPlayer === this.players[0] ? piece.style.backgroundColor = 'red' : piece.style.backgroundColor = 'blue';
    // piece.style.backgroundColor = (this.currPlayer === p1 ? 'red' : 'blue');
